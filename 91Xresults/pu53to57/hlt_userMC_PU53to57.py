# /users/kmcdermo/TargetPath91X/DisplacedPhotonHT/V6 (CMSSW_9_1_0_pre3)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/kmcdermo/TargetPath91X/DisplacedPhotonHT/V6')
)
...
process.hltL1sSingleEGNonIsoOrWithJetAndTauNoPS = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleEG40 OR L1_SingleTau120er2p1 OR L1_SingleJet180" ),
...
process.hltEG60R9Id90CaloIdLIsoLHcalPFClusterIsoFilter = cms.EDFilter( "HLTEgammaGenericQuadraticFilter",
    thrOverE2EE = cms.double( 3.0E-5 ),
    saveTags = cms.bool( True ),
    useEt = cms.bool( True ),
    thrOverE2EB = cms.double( 3.0E-5 ),
    thrRegularEE = cms.double( 7.5 ),
    thrOverEEE = cms.double( 0.032 ),
    varTag = cms.InputTag( "hltEgammaHcalPFClusterIso" ),
    thrOverEEB = cms.double( 0.03 ),
    thrRegularEB = cms.double( 12.5 ),
    lessThan = cms.bool( True ),
    l1EGCand = cms.InputTag( "hltEgammaCandidates" ),
...
process.hltEG60R9Id90CaloIdLIsoLDisplacedIdFilter = cms.EDFilter( "HLTDisplacedEgammaFilter",
    ...
    ncandcut = cms.int32( 1 ),
    inputTrack = cms.InputTag( "hltIter2MergedForPhotons" ),
...
process.HLT_Photon60_R9Id90_CaloIdL_IsoL_DisplacedIdL_PFHT350MinPFJet15_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEGNonIsoOrWithJetAndTauNoPS + process.hltPrePhoton60R9Id90CaloIdLIsoLDisplacedIdLPFHT350MinPFJet15 + process.HLTPhoton60R9Id90CaloIdLIsoLDisplacedIdLSequence + process.HLTPFHT350MinPFJet15Sequence + process.HLTEndSequence )
process.HLTriggerFinalPath = cms.Path( process.hltGtStage2Digis + process.hltScalersRawToDigi + process.hltFEDSelector + process.hltTriggerSummaryAOD + process.hltTriggerSummaryRAW + process.hltBoolFalse )


process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_Photon60_R9Id90_CaloIdL_IsoL_DisplacedIdL_PFHT350MinPFJet15_v1, process.HLTriggerFinalPath ))
...
process = L1XML(process,"L1Menu_Collisions2017_dev_r2.xml")

# adapt HLT modules to the correct process name
if 'hltTrigReport' in process.__dict__:
    process.hltTrigReport.HLTriggerResults                    = cms.InputTag( 'TriggerResults', '', 'userHLT' )

if 'hltPreExpressCosmicsOutputSmart' in process.__dict__:
    process.hltPreExpressCosmicsOutputSmart.hltResults = cms.InputTag( 'TriggerResults', '', 'userHLT' )

if 'hltPreExpressOutputSmart' in process.__dict__:
    process.hltPreExpressOutputSmart.hltResults        = cms.InputTag( 'TriggerResults', '', 'userHLT' )

if 'hltPreDQMForHIOutputSmart' in process.__dict__:
    process.hltPreDQMForHIOutputSmart.hltResults       = cms.InputTag( 'TriggerResults', '', 'userHLT' )

if 'hltPreDQMForPPOutputSmart' in process.__dict__:
    process.hltPreDQMForPPOutputSmart.hltResults       = cms.InputTag( 'TriggerResults', '', 'userHLT' )

if 'hltPreHLTDQMResultsOutputSmart' in process.__dict__:
    process.hltPreHLTDQMResultsOutputSmart.hltResults  = cms.InputTag( 'TriggerResults', '', 'userHLT' )

if 'hltPreHLTDQMOutputSmart' in process.__dict__:
    process.hltPreHLTDQMOutputSmart.hltResults         = cms.InputTag( 'TriggerResults', '', 'userHLT' )

if 'hltPreHLTMONOutputSmart' in process.__dict__:
    process.hltPreHLTMONOutputSmart.hltResults         = cms.InputTag( 'TriggerResults', '', 'userHLT' )

if 'hltDQMHLTScalers' in process.__dict__:
    process.hltDQMHLTScalers.triggerResults                   = cms.InputTag( 'TriggerResults', '', 'userHLT' )
    process.hltDQMHLTScalers.processname                      = 'userHLT'

if 'hltDQML1SeedLogicScalers' in process.__dict__:
    process.hltDQML1SeedLogicScalers.processname              = 'userHLT'
...
_customInfo['inputFile' ]=  ['file:/data/samples/SKIM/MC/neutrino83x/L1Menu_Collisions2017_dev_r2/PU53to57/L1skim_PU53to57_1.root','file:/data/samples/SKIM/MC/neutrino83x/L1Menu_Collisions2017_dev_r2/PU53to57/L1skim_PU53to57_2.root','file:/data/samples/SKIM/MC/neutrino83x/L1Menu_Collisions2017_dev_r2/PU53to57/L1skim_PU53to57_3.root','file:/data/samples/SKIM/MC/neutrino83x/L1Menu_Collisions2017_dev_r2/PU53to57/L1skim_PU53to57_4.root','file:/data/samples/SKIM/MC/neutrino83x/L1Menu_Collisions2017_dev_r2/PU53to57/L1skim_PU53to57_5.root','file:/data/samples/SKIM/MC/neutrino83x/L1Menu_Collisions2017_dev_r2/PU53to57/L1skim_PU53to57_6.root','file:/data/samples/SKIM/MC/neutrino83x/L1Menu_Collisions2017_dev_r2/PU53to57/L1skim_PU53to57_7.root','file:/data/samples/SKIM/MC/neutrino83x/L1Menu_Collisions2017_dev_r2/PU53to57/L1skim_PU53to57_8.root','file:/data/samples/SKIM/MC/neutrino83x/L1Menu_Collisions2017_dev_r2/PU53to57/L1skim_PU53to57_9.root','file:/data/samples/SKIM/MC/neutrino83x/L1Menu_Collisions2017_dev_r2/PU53to57/L1skim_PU53to57_10.root']
...
process.FastTimerService.dqmTimeResolution        =    1.   # ms
process.FastTimerService.dqmPathTimeRange         =  500.   # ms
process.FastTimerService.dqmPathTimeResolution    =    0.1  # ms
process.FastTimerService.dqmModuleTimeRange       =   50.   # ms
process.FastTimerService.dqmModuleTimeResolution  =    0.1  # ms
